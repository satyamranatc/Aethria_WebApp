...
export default function Practice() {
  ...
  async function solveInVsCode(question) {
    try {
      ...
      const payload = {
        email,
        type: "PROBLEM",
        content: `// PROBLEM: ${question.q}\n// HINT: ${question.hint}\n// LANGUAGE: ${question.language}\n\n// Write your solution below:\n`,
        language: question.language,
      };

      socket.emit("send_data", payload);

      alert("✅ Question sent to VS Code via WebSocket!");
  ...
  async function fetchFromVsCode() {
    ...
    try {
      ...
      if (response.data.code) {
        ...
        alert(
          "⚠️ No solution found. Make sure you're writing code in VS Code!"
        );
      }
    } catch (error) {
      alert(
  ...
  async function checkAnswer() {
    ...
    try {
      ...
      console.log("Checking answer with payload:", payload);
      console.log("API URL:", `${ApiUrl}/check-answer`);
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <p className="text-gray-600">
          You need to be signed in to access Practice
        </p>
      </div>
    );
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-6">
                ...
                <div className="border-t pt-4 mt-4">
                  ...
                  <p className="bg-gray-50 p-2 rounded text-sm font-mono text-gray-700 mb-4">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="bg-gray-50 rounded-lg p-3 mb-4 text-xs">
                  <p className="text-gray-700 font-semibold mb-1">
                    Sample: {question.sampleInput} → {question.sampleOutput}
                  </p>
                </div>
